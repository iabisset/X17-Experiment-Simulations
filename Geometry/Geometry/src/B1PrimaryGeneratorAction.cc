...
void B1PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  // G4double theta = (0.2181662 + 0.2181662) * ( G4UniformRand() ) - 0.2181662;
  //
  // theta = 0.2181662/2;
  // G4double thecos = cos(theta);
  // G4double xCoord = (1 - thecos)*G4UniformRand() + thecos;
  // G4double xCoordFull = 2*G4UniformRand() - 1;
  //
  // G4double rho = (0.2181662 + 0.2181662) * ( G4UniformRand() ) - 0.2181662;
  // G4double rhoAll = (2*M_PI) * ( G4UniformRand() ) - M_PI;
  // G4double thetaAll = (2*M_PI) * ( G4UniformRand() );
